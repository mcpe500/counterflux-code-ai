...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Counterflux AI",
	FIX: "Fix with Counterflux AI",
	IMPROVE: "Improve with Counterflux AI",
	ADD_TO_CONTEXT: "Add to Counterflux AI",
	NEW_TASK: "New Counterflux AI Task",
} as const
